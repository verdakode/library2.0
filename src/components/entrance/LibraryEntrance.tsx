...
export const LibraryEntrance: React.FC = () => {
  ...
  return (
    <div 
      ...
      onClick={handleEnter}
    >
      <div className={`absolute inset-0 bg-amber-500/20 mix-blend-soft-light opacity-0 
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-30">
        <span className="px-8 py-4 bg-amber-800/80 text-amber-50 text-2xl rounded-lg 
                      border-2 border-amber-600/50 backdrop-blur-sm
                      transition-all duration-300 mb-4
                      transform group-hover:scale-110 group-hover:bg-amber-700/80">
          Enter the Library
        </span>
        <span className="text-amber-100/80 text-lg transition-opacity duration-300
